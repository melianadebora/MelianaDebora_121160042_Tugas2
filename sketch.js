let dataBar = []; //bua variabel global
let dataPie = [2756, 734,1550,5456]; //supaya jadi variabel global
let colors = ['red','yellow', 'green', 'blue','orange','grey']; //untuk pieplot
...
let dataSheet;
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=Jakarta&appid=b5380cd041baf83d571d3f618cda3558&units=metric";
